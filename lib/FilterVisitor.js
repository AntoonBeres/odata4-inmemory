...
exports.FilterVisitor = exports.ODataMethodMap = void 0;
...
var FilterVisitor = /** @class */ (function () {
    ...
    FilterVisitor.prototype.Visit = function (node, context) {
        ...
        switch (node.type) {
            ...
            case undefined:
                break;
            default:
                var fun = this["Visit".concat(node.type)];
                if (fun) {
                    return fun.call(this, node, context);
                }
                console.log("Unhandled node type, falling back: ".concat(node.type));
        }
    ...
    FilterVisitor.prototype.getLiteral = function (node) {
        switch (node.value) {
            ...
            case "Edm.TimeOfDay":
                return new Date("1970-01-01T".concat(node.raw, "Z"));
            case "Edm.Duration":
    ...
    FilterVisitor.prototype.VisitMethodCallExpression = function (node, context) {
        ...
        if (!method) {
            console.log("Unknown method ".concat(node.value.method));
            return function (a) { return a; };
        }
    ...
    FilterVisitor.prototype.VisitArray = function (node, context) {
        ...
        return function (a) { return __spreadArray([], items.map(function (item) { return item(a); }), true); };
    };
